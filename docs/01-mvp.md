...
| **1 CallKit** | `CallKitBridge` (docs/07, ADR-0005), in-call screen, lock-screen answer, audio routes, mute/DTMF, hold via API — **built 2026-09-18** | Inbound and outbound calls through CallKit, answer from lock screen with the app in foreground/recently backgrounded; hold visible in the admin UI timeline | none |
